...
public class BaseClass {
	...
	public BaseClass() 
	{
		...
		try {
			fis = new FileInputStream("D:\\SelJenkinsDemo\\SampleSeleniumProjects\\config.properties");
	...
	else if(config.equalsIgnoreCase("local") && browserName.equalsIgnoreCase("chrome"))
	{
		...
		System.setProperty("webdriver.chrome.driver", "D:\\SelJenkinsDemo\\SampleSeleniumProjects\\Drivers\\chromedriver.exe");
